...
class categoryClass:
    def __init__(self,root):
        ...
        # === images ===
        self.im1 = Image.open("images/carcomp1.jpg")
        self.im1 = self.im1.resize((610,250))
        self.im1 = ImageTk.PhotoImage(self.im1)

        self.lbl_im1 = Label(self.root, image=self.im1, bd=3, relief=RAISED)
        self.lbl_im1.place(x=50,y=220)

        # self.im2 = Image.open("images/carcomp2.jpg")
    ...
    def add(self):
        ...
        try:
            if self.var_name.get() == "":
                ...
                row = cur.fetchone()
                if row != None:
                    messagebox.showerror("Error","This Category name already present, try difference",parent=self.root)
                else:
